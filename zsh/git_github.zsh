...
# requires ZSH_HIGHLIGHT_PATTERNS settings, desing in `gt`
ZSH_HIGHLIGHT_PATTERNS+=('acp ??????????????????????????????????????????????????' 'fg=green,bold')
ZSH_HIGHLIGHT_PATTERNS+=('amend ??????????????????????????????????????????????????' 'fg=green,bold')
ZSH_HIGHLIGHT_PATTERNS+=('git commit -m "??????????????????????????????????????????????????' 'fg=green,bold')
