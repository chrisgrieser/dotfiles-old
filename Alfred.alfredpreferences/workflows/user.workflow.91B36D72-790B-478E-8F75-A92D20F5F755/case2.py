...
def main(wf):
     ...
     wf.add_item(title=result, subtitle='Upper Case', valid=True, arg=result, uid='uppercase')

     result = to_lower(theString)
     wf.add_item(title=result, subtitle='Lower Case', valid=True, arg=result, uid='lowercase')

     result = to_capitalized(theString)
     wf.add_item(title=result, subtitle='Capitalized', valid=True, arg=result, uid='capitalized')

     result = to_sentence_case(theString)
     wf.add_item(title=result, subtitle='Sentence Case', valid=True, arg=result, uid='sentencecase')

     result = titlecase(theString)
     wf.add_item(title=result, subtitle='Title Case', valid=True, arg=result, uid='title	case')
