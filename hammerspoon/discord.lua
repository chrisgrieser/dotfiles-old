...
function discordWatcher(appName, eventType)
	...
	if appName ~= "Discord" and eventType == hs.application.watcher.launched then
	...
	elseif appName ~= "Discord" and eventType == hs.application.watcher.activated then
	...
	elseif appName ~= "Discord" and eventType == hs.application.watcher.deactivated then
		local clipb = hs.pasteboard.getContents()
